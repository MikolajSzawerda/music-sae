...
def getModulesStructure(module):
    ...
    for name, child in module.named_children():
        children.append({"children": getModulesStructure(child), "model": child, "module name": name})
    return children
...
def main():
    ...
    print("Glówne moduły decoder net", [dict["module name"]for dict in structure[0]["children"]])
    print("Główne moduły decoder synth", [dict["module name"] for dict in structure[1]["children"]])
